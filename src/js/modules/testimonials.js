...
const TESTIMONIALS_CONFIG = {
  ...
  testimonials: [
    ...
    {
      quote:
        "My life's been one long, glorious 'sitting on beach earning twenty percent' vibe-fest since becoming a member of You Can't Be Serious.",
      author: 'Hans Gruber',
    ...
    {
      quote:
        "These people are a stain on the internet. It's best to go about your daily routine and forget they exist.",
    ...
    {
      quote:
        "You Can't Be Serious is 90% bullshit, but it's entertaining. That's why I read it because it entertains me.",
    ...
    {
      quote:
        "All I need are some tasty waves, a cool buzz, You Can't Be Serious, and I'm fine.",
      author: 'Jeff Spicoli',
    ...
    {
      quote:
        "Listen, I don't bother nobody and nobody bothers me but these brothers are pretty cool. They see 'em you know.",
      author: 'Frank',
    ...
    {
      quote:
        "Hey man, I don't wanna rain on their parade, but these guys won't last seventeen days. Easy. Game over for them man.",
    ...
    {
      quote:
        "This quitting thing, it's a hard habit to break once you start, but one thing I'll never quit is this website.",
    ...
    {
      quote:
        "Blogs are teeming petri dishes of malignant mediocrity. Written by mental maggots consuming their own predigested pablum. You Can't Be Serious is the excretion.",
      author: 'Lydia Tár',
...
export function initTestimonials() {
  ...
  let indices = Array.from(
    { length: TESTIMONIALS_CONFIG.testimonials.length },
    (_, i) => i,
  );
  let currentIndex = 0;
  ...
  function updateTestimonial() {
    ...
    if (content) {
      ...
      setTimeout(() => {
        ...
        const testimonial =
          TESTIMONIALS_CONFIG.testimonials[indices[currentIndex]];

        testimonialElement.innerHTML = createTestimonialHTML(testimonial);
        const newContent = testimonialElement.querySelector(
          '.testimonial-content',
        );
