...
export class SidebarDropdown {
  ...
  transformIcon(iconSvg, type) {
    if (type === 'minus') {
      ...
      iconSvg.innerHTML =
        '<path d="M5 12h14" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path><path d="M12 5v14" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path>';
    }
  }
  ...
  trackDropdownEvent(dropdownItem, action) {
    const dropdownType =
      dropdownItem.getAttribute('data-dropdown-type') || 'unknown';
